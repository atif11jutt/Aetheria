...
var L = (r, t, e) =>
  t in r
    ? k(r, t, { enumerable: !0, configurable: !0, writable: !0, value: e })
    : (r[t] = e);
var m = (r, t, e) => (L(r, typeof t != "symbol" ? t + "" : t, e), e);
(function () {
...
class c {
  constructor(t) {
    (this.worksLink = t.querySelector("[nav-works]")),
      (this.worksIcon = t.querySelector(".nav-span")),
      (this.worksDropdown = t.querySelector(".menu-works-dropdown")),
      (this.worksLine = t.querySelector(".menu-works-line")),
      (this.mobileMenuIcon = t.querySelector(".mobile-menu-icon")),
      (this.mobileMenu = t.querySelector(".mobile-menu")),
      (this.mobileMenuOpen = !1),
      (this.main = t.querySelector(".main")),
...
class b {
  constructor(t, e = 0) {
    (this.images = [...t.querySelectorAll("[data-slide-img]")]),
      (this.delay = e),
      this.init();
  }
  reveal() {
...
class u {
  constructor(t, e = 0, i = -120, s = 3, o = !0) {
    (this.words = [...t.querySelectorAll(".word")]),
      (this.dataText = [...t.querySelectorAll("[data-splitting]")]),
      (this.delay = e),
      (this.duration = s),
      (this.y = i),
      (this.active = o),
  ...
  animateText(t, e, i, s = 0) {
    this.dataText.length !== 0 &&
      this.dataText.forEach((o) => {
        if (!o.hasAttribute("no-instance") && o["🍌"].lines.length > 0) {
          const a = o.querySelectorAll(".word");
          (this.timeline = gsap.timeline()),
            this.timeline.fromTo(
              ...
              { duration: i, ease: "expo", yPercent: s, delay: t }
            );
        }
      });
  }
  init() {
    this.wrapWords(this.y),
      this.active && this.animateText(this.delay, this.y, this.duration);
  }
}
class P {
  constructor(t, e = 0) {
    (this.words = [
      ...t.querySelector(".hero-intro-container").querySelectorAll(".word"),
    ]),
      (this.dataText = [
        ...t
      ...
      (this.arrowTop = t.querySelector(".arrow-wrapper.top")),
      (this.arrowBottom = t.querySelector(".arrow-wrapper.bottom")),
      (this.delay = e),
      this.init();
  }
  wrapWords() {
    gsap.set(this.words, { opacity: 0, yPercent: -120 }),
      this.words.forEach((t) => {
        let e = document.createElement("span");
        e.classList.add("char-wrap"),
          t.parentNode.insertBefore(e, t),
          e.appendChild(t);
      });
  }
  arrowLoop() {
    let t = gsap.timeline({ repeat: -1 });
    t.set([this.arrowTop, this.arrowBottom], { opacity: 0 }),
      t.set(this.arrowTop, { yPercent: -10 }),
      t.to(this.arrowTop, { opacity: 1, yPercent: 0, duration: 0.5 }),
      t.to(this.arrowBottom, { opacity: 1, duration: 0.5 }),
      t.to([this.arrowTop, this.arrowBottom], { opacity: 0, duration: 0.5 }),
      t.to(this.arrowTop, { yPercent: -10, duration: 0.5 });
  }
  animateText(t) {
    this.dataText.length !== 0 &&
      this.dataText.forEach((e) => {
        if (e["🍌"].words.length > 0) {
          const i = e.querySelectorAll(".word");
          gsap.fromTo(
            i,
            {
              "will-change": "transform",
            ...
            { duration: 3, ease: "expo", opacity: 1, yPercent: 0, delay: t }
          );
        }
      });
  }
  ...
  constructor(t, e) {
    (this.workImages = [...t.querySelectorAll(".works-intro-item")]),
      ...
      (this.selectedItems = this.workImages.filter((i) => {
        ...
        return !this.excludedIndices.includes(s);
      })),
      (this.mainItems = this.workImages.filter((i) => {
        const s = parseInt(i.getAttribute("data-flip-id"));
        return this.excludedIndices.includes(s);
      })),
      (this.items = this.mainItems.map((i) => i.querySelector("img"))),
      (this.state = Flip.getState(this.workImages)),
      this.flipContainers.forEach((i, s) => {
        i.append(this.workImages[this.flipContainers.length - (s + 1)]);
      }),
        ...
        Flip.from(this.state, {
          ...
          .eventCallback("onComplete", () => {
            this.introAnimation.animateText(),
              ...
              setTimeout(() => {
                this.finalContainers.forEach((i, s) => {
                  const o = parseInt(i.getAttribute("data-flip-id"));
      ...
      (this.formatNumber = (i, s) => {
        let o = (+i).toLocaleString("en-US").split(".");
        return s ? o[0] + "." + ((o[1] || "") + "00000000").substr(0, s) : o[0];
      }),
      gsap.to("#loaderPercentage", {
        textContent: "100",
        duration: 3,
        ease: "power1.inOut",
        modifiers: { textContent: (i) => this.formatNumber(i, 0) + "%" },
      });
  }
}
let w = null,
...
class C {
  ...
  initializeProperties(t) {
    (this.iteration = 0),
      ...
      (this.cards = [...t.querySelectorAll(".works-list-item")]),
      (this.cardsCount = this.cards.length),
      (this.cardsList = t.querySelector(".works-list")),
      (this.cardsListWrapper = t.querySelector(".works-list-wrapper")),
      (this.sectionWrapper = t.querySelector("[visibility-hidden]")),
      (this.workNavigator = t.querySelector(".work-navigator")),
      ...
      (this.scroll = null),
      (w = () => this.scrollToOffset(this.scrub.vars.offset));
  }
  setupScrollTrigger() {
    (this.trigger = ScrollTrigger.create({
      ...
      ScrollTrigger.addEventListener("scrollEnd", w);
  }
    ...
    return (
      e
        ...
        .fromTo(
          t,
          { x: "400%" },
          { x: "-400%", duration: 1, ease: "none", immediateRender: !1 },
          0
        ),
      e
    );
  }
  buildSeamlessLoop(t, e, i) {
    ...
    return (
      t
        ...
        .concat(t)
        .forEach((y, d) => {
          let l = i(t[d % t.length]);
          s.add(l, d * e), n || (n = l.duration());
        }),
      o.fromTo(
        s,
        { time: a + n / 2 },
  ...
  onScrubUpdate() {
    const t = gsap.utils.wrap(0, this.seamlessLoop.duration());
    this.seamlessLoop.time(t(this.playhead.offset));
  }
  onScrollUpdate(t) {
    const e = t.scroll();
    if (e > t.end - 1) this.wrap(1, 2);
    else if (e < 1 && t.direction < 0) this.wrap(-1, t.end - 2);
    else {
      const i = (this.iteration + t.progress) * this.seamlessLoop.duration();
      i !== this.scrub.vars.offset &&
        ((this.scrub.vars.offset = i), this.scrub.invalidate().restart());
    }
  }
  scrollToOffset(t) {
    const i =
      (this.snapTime(t) - this.seamlessLoop.duration() * this.iteration) /
      this.seamlessLoop.duration();
    if (((this.scroll = this.progressToScroll(i)), i >= 1 || i < 0)) {
      this.wrap(Math.floor(i), this.scroll);
      return;
    }
  ...
  progressToScroll(t) {
    return gsap.utils.clamp(
      1,
      this.trigger.end - 1,
      gsap.utils.wrap(0, 1, t) * this.trigger.end
    );
  }
  wrap(t, e) {
    (this.iteration += t), this.trigger.scroll(e), this.trigger.update();
  }
  navigator() {
    let t = this.scrollToOffset.bind(this),
      e = this.scrub,
      i = this.spacing;
    this.workNavigator.addEventListener("click", function (s) {
      let o = s.target.closest("[data-work-nav]");
      o &&
        (o.dataset.workNav === "next"
          ? t(e.vars.offset + i)
          : o.dataset.workNav === "prev" && t(e.vars.offset - i));
    });
  }
  draggable() {
    let t = this.scrub,
      e = this.cardsList,
      i = this.scrollToOffset.bind(this);
    v = Draggable.create(".drag-wrapper", {
      type: "x",
      trigger: e,
      onPress() {
        this.startOffset = t.vars.offset;
      },
      onDrag() {
        (t.vars.offset = this.startOffset + (this.startX - this.x) * 0.001),
...
class q {
  constructor(t) {
    (this.sections = t.querySelectorAll(".work-main-item")),
      (this.thumbnails = [...t.querySelectorAll(".work-thumbnail-item")]),
      (this.thumbnailsList = t.querySelector(".work-thumbnail-list")),
  ...
  gotoSection(t, e) {
    (t = this.wrap(t)), (this.animating = !0);
    let i = gsap.timeline({
    ...
    this.currentIndex >= 0 &&
      ...
      i.to(this.sections[t], { autoAlpha: 1, zIndex: 1 }),
      this.mm.add("(min-width: 768px)", () => {
        i.to(
          this.indicator,
          { x: 0, y: `${t * 100}%`, duration: 1, ease: "power1.inOut" },
          "<"
        ),
          this.desktopFlag &&
    ...
    ScrollTrigger.observe({
      ...
      this.thumbnails.forEach((t, e) => {
        t.addEventListener("click", () => {
          e !== this.currentIndex &&
            this.gotoSection(e, e < this.currentIndex ? -1 : 1);
        });
      }),
...
class R {
  constructor(t, e) {
    m(this, "getTotalHeight", (t) => {
      let e = 0;
      return (
        this.listViewItems
          .slice(0, t)
          .forEach((s) => (e += s.offsetHeight + window.innerHeight * 0.12)),
        e
      );
    });
    m(this, "getP", () => {
      this.resetClosestItem(),
        this.workItems.forEach((t) => {
          let e = gsap.utils.normalize(-3e3, 0, gsap.getProperty(t, "z"));
          t.setAttribute("data-z", e),
            gsap.to(t, { opacity: e + 0.2 }),
            gsap.to(t.querySelector("img"), {
              scale: e * 0.5 + 0.75,
              ease: "expo.out",
              duration: 0.5,
            });
          let i = Math.abs(e - this.targetZValue);
          i < this.closestZDifference &&
            ((this.closestZDifference = i), (this.closestItem = t));
        }),
    ...
    m(this, "resetClosestItem", () => {
      this.closestItem,
        ...
        (this.closestZDifference = 1 / 0);
    });
    (this.container = t),
      (this.textAnim = e),
      (this.grid = t.querySelector(".grid")),
      (this.gridWrap = this.grid.querySelector(".grid-wrap")),
      (this.gridItems = [...this.grid.querySelectorAll(".grid__item")]),
      (this.gridItemsInner = this.gridItems.map((i) =>
        i.querySelector(".grid__item-inner")
      )),
      (this.visualLoader = t.querySelector(".hero-visual-loader")),
      (this.workItems = [...t.querySelectorAll(".home-works-item")]),
      (this.workItemsOdd = [
        ...t.querySelectorAll(".home-works-item:nth-of-type(odd)"),
      ]),
      (this.workItemsEven = [
        ...t.querySelectorAll(".home-works-item:nth-of-type(even)"),
      ]),
      ...
      (this.x1 = [
        98.50544, 316.7302, 1158.74411, 140.10253, 128.16992, 351.22075,
        26.66366, -76.27248, 112.19732, 102.23627, 4.89015, -96.16244,
        -127.1255, 24.58326, -66.85337,
      ]),
      (this.y1 = [
  ...
  switchViews(t) {
    t === "list-view"
      ...
      : (this.textAnim.animateText(0, 0, 1, 120), this.tlList.reverse());
  }
  setUpStyles() {
    ...
    ScrollTrigger.create({
      ...
      (this.gridScroll = ScrollTrigger.create({
        ...
        onUpdate: (t) => {
          ...
          let e = (this.progress / 100) * 1800 * this.numItems;
  ...
  createTimelines() {
    gsap
      ...
      .set(this.gridItems, {
        ...
        z: (e) => this.z1[e],
        rotationX: (e) => this.rotationX1[e],
        filter: "brightness(20%)",
      })
      .to(
        this.gridItems,
        {
          xPercent: (e) => this.x1[e],
          yPercent: (e) => this.y1[e],
          rotationX: 0,
          filter: "brightness(100%)",
        },
        0
      )
      .to(this.gridWrap, { z: 6500 }, 0)
      .fromTo(this.gridItemsInner, { scale: 0.9 }, { scale: 0.5 }, 0),
      gsap
        .timeline({
          scrollTrigger: {
            trigger: this.homeWorksContainer,
      ...
      (this.tlList = gsap.timeline({ paused: !0 })),
      this.tlList
        .to(this.workItemsOdd, { x: "25vw" })
...
class H {
  ...
  initParticleImage() {
    ...
    (this.particleCanvas = {}),
      ...
      (t.width = this.particleCanvas.width),
      (t.height = this.particleCanvas.height),
      e.translate(0, this.particleCanvas.height),
      e.scale(1, -1),
      (e.font = "250pt Romie"),
      (e.textAlign = "center"),
      (e.textBaseline = "middle"),
      (e.fillStyle = "#ffffff"),
      e.fillText("404", t.width / 2, t.height / 2);
    ...
    for (let l = 0, S = i.height; l < S; l++)
      for (let h = 0, T = i.width; h < T; h++)
        if (i.data[h * 4 + l * 4 * i.width] > 128) {
          let x = Math.random() * 2e3 + (this.camera.position.z + 10);
          this.particles.initPositions.push(h),
            this.particles.initPositions.push(l),
            this.particles.initPositions.push(x),
            this.particles.minPositions.push(h),
            this.particles.minPositions.push(l),
          ...
          let I = Math.random() * 20 - 10,
            E = Math.random() * 20 - 10;
          this.particles.noiseValues.push(I),
            this.particles.noiseValues.push(E);
        }
    let s = new THREE.PlaneGeometry(1e4, 1e4),
      o = new THREE.MeshBasicMaterial({
        color: 0,
        transparent: !0,
        opacity: 0,
      }),
      a = new THREE.Mesh(s, o);
    this.planeHelperObject.push(a), this.scene.add(a);
    ...
    let y = {
      ...
      d = new THREE.ShaderMaterial({
        ...
        fragmentShader:
          document.getElementById("particle-image-fs").textContent,
      });
    (this.imageParticlesSystem = new THREE.Points(n, d)),
      (this.imageParticlesSystem.position.x =
        (-1 * this.particleCanvas.width) / 2),
      (this.imageParticlesSystem.position.y =
        (-1 * this.particleCanvas.height) / 2),
      this.scene.add(this.imageParticlesSystem),
      (this.renderer = new THREE.WebGLRenderer({ alpha: !0, antialias: !1 })),
      ...
      document.addEventListener("mousemove", this.onMousemove.bind(this), !1),
  ...
  onMousemove(t) {
    ...
    let e = {
      x: -(t.clientX - window.innerWidth / 2) / 10,
      y: -(t.clientY - window.innerHeight / 2) / 10,
    };
    this.title.style.transform = "translate3d(" + e.x + "px, " + e.y + "px, 0)";
  }
  onResize(t) {
  ...
  animate() {
    ...
    if (
      ...
      (t = s.point.x + this.particleCanvas.width / 2),
        (e = s.point.y + this.particleCanvas.height / 2);
    }
...
barba.hooks.beforeLeave((r) => {
  gsap.getTweensOf("*").forEach((t) => {
    t.kill();
  }),
    ScrollTrigger.clearScrollMemory(),
    ScrollTrigger.removeEventListener("scrollEnd", w),
    Observer.getAll().forEach((t) => t.kill()),
...
barba.init({
  ...
  views: [
    ...
    },
    {
      ...
      beforeEnter(r) {
        let t = r.next.container;
        Splitting(), new u(t, 0.8), new b(t, 0.4), new c(t);
      },
    },
    {
      namespace: "about",
    ...
    },
    {
      ...
      beforeEnter(r) {
        let t = r.next.container;
        Splitting(), new u(t, 0.8), new c(t), new q(t);
      },
    },
    {
      namespace: "archive",
